 ...
 */
uint8_t pad_buff[NUM_CONTROLLERS][PAD_BUFF_SIZE];

void Controller_Init(void) {
    // Initialize the pads
    InitPAD((char *) pad_buff[CONTROLLER_PAD_1], PAD_BUFF_SIZE, (char *) pad_buff[CONTROLLER_PAD_2], PAD_BUFF_SIZE);
...
Controller *Controller_Read(const uint8_t id) {
